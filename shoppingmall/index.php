               ...
               <table>
                   <tbody>
                       ...
                       while($row = mysqli_fetch_assoc($result)) { 
                            echo '<tr style="padding-right: 50px;"><td style=" padding-left: 100px; padding-right: 200px;"><a href="./books/'.$row["no"].'.html"><img src='.$row["image_src"].' class="td_img"></a></td><td><br><h3>'.$row["name"].'</h3> 작가 | '.$row["author"].'<br> 출판사 | '.$row["publishing"].'<br> 작가 | '.$row["author"].'<br> 출판일자 | '.$row["date_of_publication"].'<br><br><h4>'.$row["price"].'</h4> </td></tr>';
                       }
                       ?>
                   </tbody>
               </table>
